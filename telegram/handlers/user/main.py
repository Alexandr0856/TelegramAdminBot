...
from .basic import start_handler, help_handler

from filters.common import request_to_join
...
def get_user_router() -> Router:
    ...
    userRouter.chat_join_request.register(approve_request, request_to_join)
    return userRouter
